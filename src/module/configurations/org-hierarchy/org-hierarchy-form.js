...
class OrgHierarchyForm extends PageForm {
  ...
  children(list, parent) {
    ...
    return filtered.map((e) => {
      ...
      if (children.length > 0) {
        return {
          title: e.orgHierarchyName,
          value: e.orgHierarchyId,
          children: children,
        };
      } else return { title: e.orgHierarchyName, value: e.orgHierarchyId };
    });
  }
  handleData(list) {
    ...
    return (
      ...
      >
        <Spin spinning={!!this.state.isLoading}>
          ...
          >
            <Form.Item hidden name="orgHierarchyId">
              <Input />
            </Form.Item>
            <Form.Item
              label="Name"
              name="orgHierarchyName"
              rules={[
                {
                  required: true,
...
export default withForm(OrgHierarchyForm);
