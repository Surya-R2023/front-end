      ...
      >
        <Spin spinning={!!this.state.isLoading}>
          ...
          >
            ...
            {/* <Form.Item label="Selected Color" name="selectedColor">
              <Checkbox
                style={{
                  backgroundColor: this.props.form.getFieldValue("colorCode"),
                }}
                checked={!!this.props.form.getFieldValue("colorCode")}
                disabled
              />
            </Form.Item> */}

            {/* <Form.Item label="Checkbox Label" name="checkboxName">
  <Checkbox />
</Form.Item> */}
