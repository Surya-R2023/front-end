...
//   const { labelData, dropDownData, closePopup, modeName, id, handleCurrentDecrease , handleCurrentIncrease } = props;
...
//     let dd = labelData.map(e => ({ key: e.key, label: e.label, index: e.index }))
//     setDestination(dd);
//   }, [])
...
//                         <tr>
//                           <td>
//                             <Draggable key={`s${index}`} draggableId={`s${index}`} index={index}>
//                               {(provided, snapshot) => (
//                                 <div
...
//                                   {
//                                     checkBinding(index) ? <Tag icon={<CheckCircleOutlined />} color="success">
//                                       {row}
//                                     </Tag> : <Tag>
//                                       {row}
//                                     </Tag>
...
//                                   className={snapshot.isDragging ? 'dragging' : ''}>
//                                   {
//                                      row.index != null && <Tag closable onClose={() => removeBinding(index)} >
...
//             </Col>
//             <Col justify="end" >
//               <Button onClick={uploadPreviewData} type="primary">Submit</Button>
//             </Col>
//           </Row>
//         </div>
//       </DragDropContext >
