...
class UserAccess extends PageList {
  ...
  //     this.service.list({ roleId }).then((response) => {
  //       this.setState((state) => ({
  //         ...state,
  //         selectrole: roleId,
  //         featureslist: response.data,
  //         res: this.state.dup?.map((e) => ({
  //           menuName: e.menuName,
  //           feature: e.feature,
  //           menuId: e.menuId,
  //           pageId: e.pageId,
  //           parentId: e.parentId,
  //           checked:
  //             response.data?.filter((k) => {
  //               return k.menuId == e.menuId;
  //             }).length > 0
  //               ? response.data?.filter((k) => {
  //                   return k.menuId == e.menuId;
  //                 })[0].feature
  ...
  columns = [
    ...
    //   width: "300px",
    //   render: (value, record, index) => {
    //     // let indeterminate = record.feature.length!=record.checked.length?true:false
    //     return (
    //       <>
    //         <Row>
    //           <Space>
    ...
    //   key: "feature",
    //   render: (value, record, index) => {
    //     let checklist = record.feature;

    //     return (
    //       <>
    //         <Checkbox.Group
    //           options={checklist}
    //           value={this.state.selectrole ? record.checked : []}
