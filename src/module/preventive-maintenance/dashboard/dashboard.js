        ...
        <Spin spinning={this.state.isLoading}>
          <Row gutter={[10, 10]}>
            ...
            <Col sm={24} xs={24} md={12}>
              <Card title="Overall Work Order Count" size="small">
                <TimeSeriesGraph
                  type="line"
                  height={250}
            ...
            <Col sm={24} xs={24} md={12}>
              <Card size="small" title="Repeated Abnormality">
                <BarGraph
                  hideLabel={true}
                  height={250}
            ...
            <Col sm={24} xs={24} md={12}>
              <Card size="small" title="PM Checklist Execution Status">
                <Pie series={this.state.executionStatus ?? []} />
              </Card>
            </Col>
            {/* <Col sm={24} xs={24} md={12}>
              <Card size="small" title="Ticket Status">
                <Pie series={this.state.ticketStatus ?? []} />
              </Card>
            </Col> */}

            <Col sm={24} xs={24} md={12}>
              <Card size="small" title="Aging of Work Order">
                <Pie series={this.state.ageingOfTicket ?? []} />
                {/* <Pie2 series={this.state.ageingOfTicket ?? []} /> */}
              </Card>
            </Col>
          </Row>
        </Spin>
